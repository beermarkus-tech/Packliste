...
// Packliste is served from GitHub Pages under this fixed path — Stripe's
// redirect targets must resolve here to stay inside the installed PWA's
// manifest scope/start_url (both '/Packliste/').
const APP_URL = 'https://beermarkus-tech.github.io/Packliste/';
